            ...
            <CardLayout className="p-sm-5">
                ...
                <Box className="mb-5">
                    ...
                    <Row>
                        ...
                        <Col xl={8} className="ps-xl-5">
                            <Form.Check type="radio" id="checkbox4" className="mb-3" label="Send notification on each user registration" />
                            ...
                            <Form.Check type="radio" id="checkbox3" className="mb-3" label="New membership approval" />
                        </Col>
                    </Row>
                </Box>
